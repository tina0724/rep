            ...
            <div style={{ textAlign: 'center', margin: '20px' }}>
              ...
              <div>
                <Checkbox.Group type="button">
                  <Checkbox style={{ "--tick-font-size": '20px' }} value="0"><span style={{ fontSize: "20px", margin: '10px' }}>面试氛围</span></Checkbox>
                  <Checkbox value="1"><span style={{ fontSize: "20px", margin: '10px' }}>面试收获</span></Checkbox>
                  <Checkbox value="2"><span style={{ fontSize: "20px", margin: '10px' }}>专家态度</span></Checkbox>
                </Checkbox.Group>
              </div>
