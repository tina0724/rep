...
import { Checkbox, ConfigProvider, Button, Input, List, Radio, Rate } from 'zarm';
...
function StudentEva() {
  ...
  return (
    <div className="StudentEvavaluation">
        ...
        <div className="phone">
          ...
          >
            ...
            <div style={{ textAlign: 'center', margin: '20px' }}>
              <p style={{ marginBottom: '10px', fontSize: '25px', fontWeight: 'bolder' }}>本次使用令你印象最深刻的是？？</p>
              <div>
                <Checkbox.Group type="button">
                  <Checkbox style={{ "--tick-font-size": '20px' }} value="0"><span style={{ fontSize: "20px", margin: '10px' }}>选择地区</span></Checkbox>
                  <Checkbox value="1"><span style={{ fontSize: "20px", margin: '10px' }}>精准定位</span></Checkbox>
                  <Checkbox value="2"><span style={{ fontSize: "20px", margin: '10px' }}>题库导入</span></Checkbox>
                </Checkbox.Group>
              </div>
              <div style={{ margin: '10px' }}>
                <Checkbox.Group type="button">
                  <Checkbox value="0"><span style={{ fontSize: "20px", margin: '10px' }}>激励制度</span></Checkbox>
                  <Checkbox value="1"><span style={{ fontSize: "20px", margin: '10px' }}>学习排名</span></Checkbox>
                  <Checkbox value="2"><span style={{ fontSize: "20px", margin: '10px' }}>结构化面试</span></Checkbox>
                </Checkbox.Group>
              </div>
            ...
            <Button style={{background:'#0C5757',width:'200px'}} shape='round' blocked size='lg' theme="primary">提交</Button>
